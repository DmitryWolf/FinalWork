...
if ($web == 1){
    ...
    <?php }
        ...
        <tr><td>
        <p><h6 align="center"><font size="6" color="darkblue" face="Calibri"><?php echo $_COOKIE["cookieName"]?>, JavaScript - то, что Вам нужно. JasaScript постоянно совершенствуется, а также на нем написано огромное количество сайтов. Он занимает одну из лидирующих позиций среди web языков программирования</font></h6></p>

        </td></tr>
    <?php }
    else if($php >= $python && $php >= $js){ ?>
        <tr><td>
        <p><h6 align="center"><font size="6" color="darkblue" face="Calibri"><?php echo $_COOKIE["cookieName"]?>, рекомендую Вам начать с PHP. У него довольно простой синтаксис, а также на нем написано огромное количество сайтов. Он занимает одну из лидирующих позиций среди web языков программирования</font></h6></p>
    ...
    if($java >= $cs){ ?>
        <tr><td>
        <p><h6 align="center"><font size="6" color="darkblue" face="Calibri"><?php echo $_COOKIE["cookieName"]?>, для разработки мобильных приложений Вам потребуются такие языки, как Java и Swift. С помощью этих языков вы сможете писать на Android и устройства компании Apple</font></h6></p>
